...
Attachment theory is the most validated framework we have for understanding relationship patterns. Developed by psychiatrist John Bowlby in the 1960s, it proposes that our early experiences with caregivers create "internal working models" — mental templates that guide how we approach relationships throughout life.<sup>[[1]](#references)</sup>

Mary Ainsworth's "Strange Situation" studies in 1978 identified distinct patterns in how infants responded to separation from caregivers.<sup>[[2]](#references)</sup> In 1987, Hazan and Shaver made the breakthrough connection: these same patterns appear in adult romantic relationships.<sup>[[3]](#references)</sup>
...
- Use "hyperactivating strategies" — constant vigilance for relationship threats<sup>[[4]](#references)</sup>
...
- Use "deactivating strategies" — suppressing attachment needs<sup>[[4]](#references)</sup>
...
- fMRI studies show altered amygdala and prefrontal cortex activity<sup>[[5]](#references)</sup>

*Note: Prevalence percentages vary across studies and cultures. The U.S. National Comorbidity Survey found 63.5% secure, 22.2% avoidant, and 5.5% anxious in a sample of 5,645 adults.<sup>[[6]](#references)</sup>*

## The Neuroscience of Attachment

Attachment isn't just psychology — it's biology. A comprehensive 2017 review of attachment neuroscience revealed:<sup>[[7]](#references)</sup>
...
Research shows this pairing persists despite mutual dissatisfaction because the emotional dynamics feel familiar to both partners — each unconsciously seeks to recreate (and hopefully resolve) unmet childhood emotional needs.<sup>[[8]](#references)</sup>
...
A 6-year longitudinal study found:<sup>[[9]](#references)</sup>
...
A 2019 review of longitudinal research concluded: "Early experiences do NOT determine adult outcomes — attachment can change."<sup>[[10]](#references)</sup> Attachment styles are more malleable in childhood and adolescence, but change remains possible throughout life.
...
A 2019 meta-analysis examined how attachment affects both your own *and* your partner's relationship satisfaction:<sup>[[11]](#references)</sup>
...
Another meta-analysis found that the negative effects of insecure attachment on relationships get **worse over time** — attachment effects compound in longer relationships.<sup>[[12]](#references)</sup>

A 15-year longitudinal study found that attachment security predicted greater marital satisfaction, though the relationship to divorce was mediated through satisfaction rather than direct.<sup>[[13]](#references)</sup>
...
*For a validated assessment, the Experiences in Close Relationships (ECR) scale measures attachment on two dimensions: anxiety and avoidance.<sup>[[14]](#references)</sup>*
...
Attachment theory was developed in Western contexts, but research shows secure attachment is a **universal norm** across cultures — most children everywhere develop secure attachments when caregiving is consistent.<sup>[[15]](#references)</sup>
